    ...
    <div className="bg-black text-white px-20 py-20">
      <div className="flex justify-between">
        <h1 className="font-bold text-4xl">
          ...
          <span>
            <img src="/images/title-icon2.png" alt="icon" className="inline" />
          </span>
        </h1>
        <div className="flex ">
          <a
      ...
      <p className="w-[60%] mt-4 leading-8">
        Secure, Rewarding, Lowest Fees and Unlimited Rewards. We Have it all to
        provide the best experience to buy your first Bitcoin.
      </p>
